...
export async function setRandomViewport(page) {
    ...
    console.log(`Testing on ${randomViewport.device} with resolution ${randomViewport.width}x${randomViewport.height}`);
}

module.exports.setRandomViewport = setRandomViewport;
